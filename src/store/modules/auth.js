  ...
  [actionTypes.register] (context, credentials)  {
    return new Promise((resolve) => {
      ...
      authApi.register(credentials)
        ...
        .catch(result => context.commit(mutationTypes.registerFailure, result.response.data.errors))
    })
  },
  ...
  [actionTypes.login] (context, credentials)  {
    return new Promise((resolve) => {
      ...
      authApi.login(credentials)
        ...
        .catch(result => context.commit(mutationTypes.loginFailure, result.response.data.errors))
    })
  },
  ...
  [actionTypes.updateCurrentUser] (context, { currentUserInput })  {
    return new Promise((resolve) => {
      ...
      authApi.updateCurrentUser(currentUserInput)
        ...
        .catch(result => context.commit(mutationTypes.updateCurrentUserFailure, result.response.data.errors))
    })
  },
